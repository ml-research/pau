...
__global__ void pau_cuda_forwardA_kernel_$degs[0]_$degs[1]( const scalar_t* __restrict__ x, const scalar_t* __restrict__ a,
...
at::Tensor pau_cuda_forwardA_$degs[0]_$degs[1](torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.type(), "pau_cuda_forwardA_$degs[0]_$degs[1]", ([&] {
    pau_cuda_forwardA_kernel_$degs[0]_$degs[1]<scalar_t>
        <<<numBlocks, blockSize>>>(
            x.data<scalar_t>(),
            n.data<scalar_t>(),
            d.data<scalar_t>(),
...
template <typename scalar_t>
__global__ void pau_cuda_backwardA_kernel_$degs[0]_$degs[1](
...
std::vector<torch::Tensor> pau_cuda_backwardA_$degs[0]_$degs[1](torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    ...
    AT_DISPATCH_FLOATING_TYPES(x.type(), "pau_cuda_backwardA_$degs[0]_$degs[1]", ([&] {
    pau_cuda_backwardA_kernel_$degs[0]_$degs[1]<scalar_t>
        <<<16, blockSize>>>(
