...
__global__ void pau_cuda_backward_kernel_3_3(
    ...
    __shared__ scalar_t sdd[3];
    __shared__ scalar_t sdn[3];
    ...
    for (int index = blockIdx.x * blockDim.x + threadIdx.x;
         ...
         index += blockDim.x * gridDim.x)
      {
        ...
        scalar_t d_i_dp0 = (mpq2*axp0*copysign( scalar_t(1.0), d_0 ));
        scalar_t d_i_d_reg0 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp0*scalar_t(1)*copysign( scalar_t(1.0), xp1)+d_i_d0*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d0 += d_i_d0 * grad_o + alpha * d_i_d_reg0;
                scalar_t d_i_d1 = (mpq2*axp2*copysign( scalar_t(1.0), d_1 ));
        scalar_t d_i_dp1 = (mpq2*axp1*copysign( scalar_t(1.0), d_1 ));
        scalar_t d_i_d_reg1 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp1*scalar_t(2)*copysign( scalar_t(1.0), xp1)+d_i_d1*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d1 += d_i_d1 * grad_o + alpha * d_i_d_reg1;
                scalar_t d_i_d2 = (mpq2*axp3*copysign( scalar_t(1.0), d_2 ));
        scalar_t d_i_dp2 = (mpq2*axp2*copysign( scalar_t(1.0), d_2 ));
        scalar_t d_i_d_reg2 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp2*scalar_t(3)*copysign( scalar_t(1.0), xp1)+d_i_d2*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d2 += d_i_d2 * grad_o + alpha * d_i_d_reg2;
        ...
        scalar_t d_i_n_reg1 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n1*(-S)/Q + d_i_n0*scalar_t(1));
        d_n1 += d_i_n1 * grad_o + alpha * d_i_n_reg1;
                scalar_t d_i_n2  = xp2/Q;
        scalar_t d_i_n_reg2 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n2*(-S)/Q + d_i_n1*scalar_t(2));
        d_n2 += d_i_n2 * grad_o + alpha * d_i_n_reg2;
                scalar_t d_i_n3  = xp3/Q;
        scalar_t d_i_n_reg3 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n3*(-S)/Q + d_i_n2*scalar_t(3));
        d_n3 += d_i_n3 * grad_o + alpha * d_i_n_reg3;
...
std::vector<torch::Tensor> pau_cuda_backward_3_3(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
...
__global__ void pau_cuda_backward_kernel_4_4(
    ...
    __shared__ scalar_t sdd[4];
    __shared__ scalar_t sdn[4];
    ...
    for (int index = blockIdx.x * blockDim.x + threadIdx.x;
         ...
         index += blockDim.x * gridDim.x)
      {
        ...
        scalar_t d_i_dp3 = (mpq2*axp3*copysign( scalar_t(1.0), d_3 ));
        scalar_t d_i_d_reg3 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp3*scalar_t(4)*copysign( scalar_t(1.0), xp1)+d_i_d3*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d3 += d_i_d3 * grad_o + alpha * d_i_d_reg3;
        ...
        scalar_t d_i_n_reg4 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n4*(-S)/Q + d_i_n3*scalar_t(4));
        d_n4 += d_i_n4 * grad_o + alpha * d_i_n_reg4;
...
std::vector<torch::Tensor> pau_cuda_backward_4_4(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
    auto d_x = at::empty_like(x);
    auto d_n = at::zeros_like(n);
    auto d_d = at::zeros_like(d);
...
__global__ void pau_cuda_backward_kernel_5_5(
    ...
    __shared__ scalar_t sdd[5];
    __shared__ scalar_t sdn[5];
    ...
    for (int index = blockIdx.x * blockDim.x + threadIdx.x;
         ...
         index += blockDim.x * gridDim.x)
      {
        ...
        scalar_t d_i_dp4 = (mpq2*axp4*copysign( scalar_t(1.0), d_4 ));
        scalar_t d_i_d_reg4 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp4*scalar_t(5)*copysign( scalar_t(1.0), xp1)+d_i_d4*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d4 += d_i_d4 * grad_o + alpha * d_i_d_reg4;
        ...
        scalar_t d_i_n_reg5 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n5*(-S)/Q + d_i_n4*scalar_t(5));
        d_n5 += d_i_n5 * grad_o + alpha * d_i_n_reg5;
...
std::vector<torch::Tensor> pau_cuda_backward_5_5(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
    auto d_x = at::empty_like(x);
    auto d_n = at::zeros_like(n);
    auto d_d = at::zeros_like(d);
...
__global__ void pau_cuda_backward_kernel_6_6(
    ...
    __shared__ scalar_t sdd[6];
    __shared__ scalar_t sdn[6];
    ...
    for (int index = blockIdx.x * blockDim.x + threadIdx.x;
         ...
         index += blockDim.x * gridDim.x)
      {
        ...
        scalar_t d_i_dp5 = (mpq2*axp5*copysign( scalar_t(1.0), d_5 ));
        scalar_t d_i_d_reg5 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp5*scalar_t(6)*copysign( scalar_t(1.0), xp1)+d_i_d5*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d5 += d_i_d5 * grad_o + alpha * d_i_d_reg5;
        ...
        scalar_t d_i_n_reg6 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n6*(-S)/Q + d_i_n5*scalar_t(6));
        d_n6 += d_i_n6 * grad_o + alpha * d_i_n_reg6;
...
std::vector<torch::Tensor> pau_cuda_backward_6_6(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
    auto d_x = at::empty_like(x);
    auto d_n = at::zeros_like(n);
    auto d_d = at::zeros_like(d);
...
__global__ void pau_cuda_backward_kernel_7_7(
    ...
    __shared__ scalar_t sdd[7];
    __shared__ scalar_t sdn[7];
    ...
    for (int index = blockIdx.x * blockDim.x + threadIdx.x;
         ...
         index += blockDim.x * gridDim.x)
      {
        ...
        scalar_t d_i_dp6 = (mpq2*axp6*copysign( scalar_t(1.0), d_6 ));
        scalar_t d_i_d_reg6 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp6*scalar_t(7)*copysign( scalar_t(1.0), xp1)+d_i_d6*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d6 += d_i_d6 * grad_o + alpha * d_i_d_reg6;
        ...
        scalar_t d_i_n_reg7 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n7*(-S)/Q + d_i_n6*scalar_t(7));
        d_n7 += d_i_n7 * grad_o + alpha * d_i_n_reg7;
...
std::vector<torch::Tensor> pau_cuda_backward_7_7(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
    auto d_x = at::empty_like(x);
    auto d_n = at::zeros_like(n);
    auto d_d = at::zeros_like(d);
...
__global__ void pau_cuda_backward_kernel_8_8(
    ...
    __shared__ scalar_t sdd[8];
    __shared__ scalar_t sdn[8];
    ...
    for (int index = blockIdx.x * blockDim.x + threadIdx.x;
         ...
         index += blockDim.x * gridDim.x)
      {
        ...
        scalar_t d_i_dp7 = (mpq2*axp7*copysign( scalar_t(1.0), d_7 ));
        scalar_t d_i_d_reg7 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_dp7*scalar_t(8)*copysign( scalar_t(1.0), xp1)+d_i_d7*( R/P + scalar_t(2.0)*(-S)/Q));
        d_d7 += d_i_d7 * grad_o + alpha * d_i_d_reg7;
        ...
        scalar_t d_i_n_reg8 = scalar_t(2.0)*(d_i_x-scalar_t(1.0))*(d_i_n8*(-S)/Q + d_i_n7*scalar_t(8));
        d_n8 += d_i_n8 * grad_o + alpha * d_i_n_reg8;
...
std::vector<torch::Tensor> pau_cuda_backward_8_8(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
    auto d_x = at::empty_like(x);
    auto d_n = at::zeros_like(n);
    auto d_d = at::zeros_like(d);
...
std::vector<torch::Tensor> pau_cuda_backward_5_4(float alpha, torch::Tensor grad_output, torch::Tensor x, torch::Tensor n, torch::Tensor d){
    const auto x_size = x.numel();
    auto d_x = at::empty_like(x);
    auto d_n = at::zeros_like(n);
    auto d_d = at::zeros_like(d);
